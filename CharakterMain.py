...
class Ui_formMain(object):
    def setupUi(self, formMain):
        ...
        self.buttonExportRoll20 = QtWidgets.QPushButton(formMain)
        self.buttonExportRoll20.setMinimumSize(QtCore.QSize(100, 0))
        self.buttonExportRoll20.setMaximumSize(QtCore.QSize(16777214, 16777215))
        self.buttonExportRoll20.setObjectName("buttonExportRoll20")
        self.horizontalLayout_3.addWidget(self.buttonExportRoll20)
    ...
    def retranslateUi(self, formMain):
        ...
        self.buttonExportRoll20.setText(_translate("formMain", "Roll20 Export"))
